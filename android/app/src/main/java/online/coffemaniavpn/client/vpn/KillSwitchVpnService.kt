...
class KillSwitchVpnService : VpnService() {
    ...
    companion object {
        private const val ACTION_ENGAGE = "online.coffemaniavpn.client.vpn.KILL_SWITCH_ENGAGE"
        private const val ACTION_RELEASE = "online.coffemaniavpn.client.vpn.KILL_SWITCH_RELEASE"
