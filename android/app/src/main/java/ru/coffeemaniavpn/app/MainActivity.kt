                ...
                key(configuration.locales.toLanguageTags()) {
                    ...
                    CoffemaniaTheme {
                        ...
                        AppShell(
                            ...
                            onRefreshServersAndPing = viewModel::refreshServersAndPing,
                            onPasteLinkClick = viewModel::pasteSubscriptionFromClipboard,
                            onImportUrl = viewModel::importSubscriptionUrl,
                            onAcceptClipboard = viewModel::acceptClipboardSubscription,
                            onDismissClipboard = viewModel::dismissClipboardSubscription,
                            onDismissForeignPrompt = viewModel::dismissForeignSubscriptionPrompt,
                            onPasteNewLink = viewModel::pasteSubscriptionFromClipboard,
