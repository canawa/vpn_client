...
import work.bavshield.vpn.data.InstalledAppsLoader
...
import work.bavshield.vpn.data.SplitTunnelAppsMode
import work.bavshield.vpn.data.SplitTunnelSitesMode
...
fun SplitTunnelSitesScreen(
    ...
    Column(
        ...
        SettingsSectionLabel(text = stringResource(R.string.mode))
        SettingsDivider()

        SettingsRadioRow(
            title = stringResource(R.string.sites_proxy_only),
        ...
        SettingsRadioRow(
            title = stringResource(R.string.sites_direct_bypass),
        ...
        OutlinedTextField(
            ...
            enabled = enabled,
            label = { Text(stringResource(R.string.sites_field_label)) },
        ...
        Text(
            text = stringResource(R.string.sites_hint),
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = bavShieldColors().espresso,
                contentColor = bavShieldColors().milkFoam,
                disabledContainerColor = bavShieldColors().latte,
                disabledContentColor = bavShieldColors().mocha,
            ),
        ) {
            Text(stringResource(if (domainsDirty) R.string.action_apply else R.string.action_applied))
        }
    }
}
...
fun SplitTunnelAppsScreen(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
            ...
            SettingsRadioRow(
                title = stringResource(R.string.apps_include_only),
            ...
            SettingsRadioRow(
                title = stringResource(R.string.apps_exclude_selected),
            ...
            SettingsSectionLabel(
                text = when {
                    isLoadingApps -> stringResource(R.string.apps_loading_label)
                    else -> stringResource(R.string.apps_count, apps.size)
                },
            )
            SettingsDivider()
        }
...
private fun SettingsToggleTitle(title: String, enabled: Boolean) {
    Text(
        ...
        color = if (enabled) bavShieldColors().espresso else bavShieldColors().mocha,
    )
}
