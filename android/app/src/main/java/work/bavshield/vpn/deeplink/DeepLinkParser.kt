package work.bavshield.vpn.deeplink

import android.net.Uri
import android.util.Base64
import work.bavshield.vpn.data.ShareLinkParser
import work.bavshield.vpn.util.AppLog
import java.net.URLDecoder
import java.nio.charset.StandardCharsets

object DeepLinkParser {
    val supportedSchemes = setOf("bavshield", "bavvpn", "bav")
    ...
    private fun looksLikeSubscriptionBody(value: String): Boolean =
        ShareLinkParser.looksLikeShareLink(value) ||
            value.startsWith("[") ||
            value.startsWith("{")
